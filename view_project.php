					...
					<div class="table-responsive">
						<table class="table table-condensed m-0 table-hover">
							...
							<tbody>
								<?php
								$i = 1;
								$tasks = $conn->query("SELECT * FROM task_list WHERE project_id = {$id} ORDER BY status ASC, task ASC");
						...
						<div class="post">
							...
							<div class="user-block">
								...
								<span class="description">
									...
									<span>Start: <b>
											<?php echo date('h:i A', strtotime($row['date'] . ' ' . $row['start_time'])) ?>
										</b></span>
									<span> | </span>
									<span>End: <b>
											<?php echo date('h:i A', strtotime($row['date'] . ' ' . $row['end_time'])) ?>
										</b></span>
								</span>
