		...
		<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT t.*,p.name as pname,p.start_date,p.status as pstatus, p.end_date,p.id as pid FROM task_list t inner join project_list p on p.id = t.project_id $where ORDER BY FIELD(pstatus, 0, 1, 2, 3, 4, 5), status ASC, p.name ASC");
